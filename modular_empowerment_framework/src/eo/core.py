...
class Agent:
    ...
    def __init__(self, agent_id: str, initial_state: Dict[str, Any] = None):
        """
        Initialize an agent.
...
class EOCore:
    ...
    def add_agent(self, agent_id: str, initial_state: Dict[str, Any] = None) -> Agent:
        """
    ...
    def step(self) -> Dict[str, Any]:
        ...
        original_states = {agent_id: self.environment.get_agent(agent_id).get_state() 
                          for agent_id in agent_ids}
